...
navigate(`/room/${roomcode}`) ; 
  ...
  return (
    ...
    <div className='relative'>
      ...
      <div className="z-10 relative h-screen px-4 py-[6rem] bg-black/60">
      <form action="" onSubmit={submitcode}
        className="flex flex-col items-center justify-center text-[white]">
        <label htmlFor="" className='font-bold text-[38px] sm:text-[52px] md:text-[62px] lg:text-[72px] pt-12'>Video Chat & Call App</label>
